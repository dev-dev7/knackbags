(function(x) {
    ...
    (function(d, f) {
        ...
        N = function() {
            function f(a) {
                return null == a ? String(a) : q[F.call(a)] || "object"
            }
            function g(a) {
                return "function" == f(a)
            }
            ...
            function p(a) {
                return m(a) && !h(a) && Object.getPrototypeOf(a) == Object.prototype
            }
            function O(a) {
            ...
            function A(a) {
                return a in S ? S[a] : S[a] = new RegExp("(^|\\s)" + a + "(\\s|$)")
            }
            function x(a, e) {
                return "number" != typeof e || W[D(a)] ? e : e + "px"
            }
            function I(a) {
                return "children"in a ? l.call(a.children) : n.map(a.childNodes, function(a) {
                    if (1 == a.nodeType)
                        return a
                })
            }
            ...
            function X(a, e, b) {
                for (y in e)
                    b && (p(e[y]) || Y(e[y])) ? (p(e[y]) && !p(a[y]) && (a[y] = {}),
                    Y(e[y]) && !Y(a[y]) && (a[y] = []),
                    X(a[y], e[y], b)) : e[y] !== t && (a[y] = e[y])
            }
            function J(a, e) {
                return null == e ? n(a) : n(a).filter(e)
            }
            function E(a, e, b, k) {
            ...
            function G(a, e) {
                var b = a.className || ""
                  , k = b && b.baseVal !== t;
                if (e === t)
                    return k ? b.baseVal : b;
                k ? b.baseVal = e : a.className = e
            }
            function c(a) {
                try {
                    return a ? "true" == a || ("false" == a ? !1 : "null" == a ? null : +a + "" == a ? +a : /^[\[\{]/.test(a) ? n.parseJSON(a) : a) : a
                } catch (ka) {
                    return a
                }
            }
            function K(a, e) {
                e(a);
                for (var b = 0, k = a.childNodes.length; b < k; b++)
                    K(a.childNodes[b], e)
            }
            var t, y, L, C = [], w = C.concat, u = C.filter, l = C.slice, z = d.document, H = {}, S = {}, W = {
                "column-count": 1,
                columns: 1,
                "font-weight": 1,
                "line-height": 1,
                ...
                "z-index": 1,
                zoom: 1
            }, T = /^\s*<(\w+|!)[^>]*>/, v = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, aa = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig, U = /^(?:body|html)$/i, ba = /([A-Z])/g, Z = "val css html text data width height offset".split(" "), P = z.createElement("table"), b = z.createElement("tr"), a = {
                ...
                th: b,
                "*": z.createElement("div")
            }, e = /complete|loaded|interactive/, k = /^[\w-]*$/, q = {}, F = q.toString, B = {}, ca = z.createElement("div"), ja = {
                tabindex: "tabIndex",
                readonly: "readOnly",
                "for": "htmlFor",
                "class": "className",
            ...
            var ha = function(a) {
                return u.call(a, function(e, b) {
                    return a.indexOf(e) == b
                })
            };
            B.fragment = function(e, b, k) {
                var q;
                v.test(e) && (q = n(z.createElement(RegExp.$1)));
                if (!q) {
                    e.replace && (e = e.replace(aa, "<$1></$2>"));
                    b === t && (b = T.test(e) && RegExp.$1);
                    b in a || (b = "*");
                    var c = a[b];
                    c.innerHTML = "" + e;
                    q = n.each(l.call(c.childNodes), function() {
                        c.removeChild(this)
                    })
                }
                if (p(k)) {
                    var ia = n(q);
                    n.each(k, function(a, e) {
                        if (-1 < Z.indexOf(a))
                            ia[a](e);
                        else
                            ia.attr(a, e)
            ...
            ;
            B.qsa = function(a, e) {
                var b, q = "#" == e[0], c = !q && "." == e[0], F = q || c ? e.slice(1) : e, f = k.test(F);
                return a.getElementById && f && q ? (b = a.getElementById(F)) ? [b] : [] : 1 !== a.nodeType && 9 !== a.nodeType && 11 !== a.nodeType ? [] : l.call(f && !q && a.getElementsByClassName ? c ? a.getElementsByClassName(F) : a.getElementsByTagName(e) : a.querySelectorAll(e))
            }
            ;
            n.contains = z.documentElement.contains ? function(a, e) {
            ...
            n.map = function(a, e) {
                ...
                if (O(a))
                    ...
                    for (k in a)
                        q = e(a[k], k),
                        null != q && b.push(q);
                return 0 < b.length ? n.fn.concat.apply([], b) : b
            }
            ;
            n.each = function(a, e) {
                var b;
            ...
            ;
            d.JSON && (n.parseJSON = JSON.parse);
            n.each("Boolean Number String Function Array Date RegExp Object Error".split(" "), function(a, e) {
            ...
            n.fn = {
                ...
                concat: function() {
                    ...
                    return w.apply(B.isZ(this) ? this.toArray() : this, e)
                },
                map: function(a) {
                    return n(n.map(this, function(e, b) {
                        return a.call(e, b, e)
                    }))
                },
                slice: function() {
                ...
                ready: function(a) {
                    e.test(z.readyState) && z.body ? a(n) : z.addEventListener("DOMContentLoaded", function() {
                        a(n)
                    }, !1);
                    return this
                },
                get: function(a) {
                    return a === t ? l.call(this) : this[0 <= a ? a : a + this.length]
                },
                toArray: function() {
                    return this.get()
                },
                ...
                filter: function(a) {
                    return g(a) ? this.not(this.not(a)) : n(u.call(this, function(e) {
                        return B.matches(e, a)
                    }))
                },
                add: function(a, e) {
                    return n(ha(this.concat(n(a, e))))
                },
                is: function(a) {
                ...
                not: function(a) {
                    ...
                    if (g(a) && a.call !== t)
                        ...
                        var b = "string" == typeof a ? this.filter(a) : O(a) && g(a.item) ? l.call(a) : n(a);
                ...
                has: function(a) {
                    return this.filter(function() {
                        return m(a) ? n.contains(this, a) : n(this).find(a).size()
                    })
                },
                eq: function(a) {
                ...
                find: function(a) {
                    var e = this;
                    return a ? "object" == typeof a ? n(a).filter(function() {
                        var a = this;
                        return C.some.call(e, function(e) {
                            return n.contains(e, a)
                        })
                    }) : 1 == this.length ? n(B.qsa(this[0], a)) : this.map(function() {
                        return B.qsa(this, a)
                    }) : n()
                },
                closest: function(a, e) {
                    var b = []
                      , k = "object" == typeof a && n(a);
                    this.each(function(q, c) {
                        for (; c && !(k ? 0 <= k.indexOf(c) : B.matches(c, a)); )
                ...
                parent: function(a) {
                    return J(ha(this.pluck("parentNode")), a)
                },
                children: function(a) {
                ...
                siblings: function(a) {
                    return J(this.map(function(a, e) {
                        return u.call(I(e.parentNode), function(a) {
                            return a !== e
                        })
                    }), a)
                },
                ...
                wrap: function(a) {
                    ...
                    return this.each(function(q) {
                        n(this).wrapAll(e ? a.call(this, q) : k ? b.cloneNode(!0) : b)
                    })
                },
                wrapAll: function(a) {
                    if (this[0]) {
                        n(this[0]).before(a = n(a));
                ...
                wrapInner: function(a) {
                    ...
                    return this.each(function(b) {
                        var k = n(this)
                          , q = k.contents();
                        b = e ? a.call(this, b) : a;
                        q.length ? q.wrapAll(b) : k.append(b)
                    })
                },
                unwrap: function() {
                ...
                toggle: function(a) {
                    return this.each(function() {
                        var e = n(this);
                        (a === t ? "none" == e.css("display") : a) ? e.show() : e.hide()
                    })
                },
                prev: function(a) {
                    return n(this.pluck("previousElementSibling")).filter(a || "*")
                },
                next: function(a) {
                    return n(this.pluck("nextElementSibling")).filter(a || "*")
                },
                html: function(a) {
                    return 0 in arguments ? this.each(function(e) {
                        var b = this.innerHTML;
                        n(this).empty().append(E(this, a, e, b))
                        ...
                        if (1 === this.nodeType)
                            if (m(a))
                                for (y in a) {
                                    var k = y;
                                    b = a[y];
                                    null == b ? this.removeAttribute(k) : this.setAttribute(k, b)
                                }
                            else
                                k = a,
                                b = E(this, e, b, this.getAttribute(a)),
                                null == b ? this.removeAttribute(k) : this.setAttribute(k, b)
                    }) : 0 in this && 1 == this[0].nodeType && null != (b = this[0].getAttribute(a)) ? b : t
                },
                ...
                offset: function(a) {
                    ...
                    if (!this.length)
                        return null;
                    if (z.documentElement !== this[0] && !n.contains(z.documentElement, this[0]))
                        return {
                            top: 0,
                            left: 0
                        };
                ...
                css: function(a, e) {
                    if (2 > arguments.length) {
                        ...
                        if (Y(a)) {
                            if (!b)
                                return;
                            var k = {}
                              , q = getComputedStyle(b, "");
                            n.each(a, function(a, e) {
                                k[e] = b.style[fa(e)] || q.getPropertyValue(e)
                            });
                            return k
                        }
                    }
                    var c = "";
                    if ("string" == f(a))
                        e || 0 === e ? c = D(a) + ":" + x(a, e) : this.each(function() {
                            this.style.removeProperty(D(a))
                        });
                    else
                        for (y in a)
                            a[y] || 0 === a[y] ? c += D(y) + ":" + x(y, a[y]) + ";" : this.each(function() {
                    ...
                    return a ? this.each(function(e) {
                        if ("className"in this) {
                            ...
                            E(this, a, e, b).split(/\s+/g).forEach(function(a) {
                                n(this).hasClass(a) || L.push(a)
                            }, this);
                            L.length && G(this, b + (b ? " " : "") + L.join(" "))
                        }
                    }) : this
                },
                ...
                toggleClass: function(a, e) {
                    return a ? this.each(function(b) {
                        var k = n(this);
                        E(this, a, b, G(this)).split(/\s+/g).forEach(function(a) {
                            (e === t ? !k.hasClass(a) : e) ? k.addClass(a) : k.removeClass(a)
                        })
                    }) : this
                },
                scrollTop: function(a) {
                    if (this.length) {
                        ...
                        return a === t ? e ? this[0].scrollTop : this[0].pageYOffset : this.each(e ? function() {
                            this.scrollTop = a
                        }
                        : function() {
                ...
                scrollLeft: function(a) {
                    if (this.length) {
                        ...
                        return a === t ? e ? this[0].scrollLeft : this[0].pageXOffset : this.each(e ? function() {
                            this.scrollLeft = a
                        }
                        : function() {
                ...
                position: function() {
                    if (this.length) {
                        var a = this[0]
                          , e = this.offsetParent()
                          , b = this.offset()
                          , k = U.test(e[0].nodeName) ? {
                            top: 0,
                            left: 0
                        } : e.offset();
                        b.top -= parseFloat(n(a).css("margin-top")) || 0;
                        b.left -= parseFloat(n(a).css("margin-left")) || 0;
                        k.top += parseFloat(n(e[0]).css("border-top-width")) || 0;
                        k.left += parseFloat(n(e[0]).css("border-left-width")) || 0;
                        return {
                            top: b.top - k.top,
                            left: b.left - k.left
                        }
                ...
                offsetParent: function() {
                    return this.map(function() {
                        for (var a = this.offsetParent || z.body; a && !U.test(a.nodeName) && "static" == n(a).css("position"); )
                            a = a.offsetParent;
                        return a
                    })
                }
            ...
            ["width", "height"].forEach(function(a) {
                ...
                n.fn[a] = function(b) {
                    var k, q = this[0];
                    return b === t ? h(q) ? q["inner" + e] : null != q && q.nodeType == q.DOCUMENT_NODE ? q.documentElement["scroll" + e] : (k = this.offset()) && k[a] : this.each(function(e) {
                        q = n(this);
                        q.css(a, E(this, b, e, q[a]()))
                    })
                }
            });
            ["after", "prepend", "before", "append"].forEach(function(a, e) {
                var b = e % 2;
                n.fn[a] = function() {
                    var a, k = n.map(arguments, function(e) {
                        var b = [];
                        a = f(e);
                    ...
                    return 1 > k.length ? this : this.each(function(a, F) {
                        ...
                        var f = n.contains(z.documentElement, q);
                ...
                ;
                n.fn[b ? a + "To" : "insert" + (e ? "Before" : "After")] = function(e) {
                    n(e)[a](this);
                    return this
                }
            });
            B.Z.prototype = M.prototype = n.fn;
            B.uniq = ha;
        ...
        (function(f) {
            function g(c) {
                return c._zid || (c._zid = x++)
            }
            function h(c, f, d, h) {
                f = m(f);
                if (f.ns)
                    var u = new RegExp("(?:^| )" + f.ns.replace(" ", " .* ?") + "(?: |$)");
                return (E[g(c)] || []).filter(function(c) {
                    return c && (!f.e || c.e == f.e) && (!f.ns || u.test(c.ns)) && (!d || g(c.fn) === g(d)) && (!h || c.sel == h)
                })
            }
            function m(c) {
                c = ("" + c).split(".");
            ...
            function O(d, l, h, H, r, y, V) {
                ...
                l.split(/\s/).forEach(function(g) {
                    ...
                    l.fn = h;
                    l.sel = r;
                    l.e in t && (h = function(c) {
                        var b = c.relatedTarget;
                        if (!b || b !== this && !f.contains(this, b))
                            return l.fn.apply(this, arguments)
                    }
                    );
                    var u = (l.del = y) || h;
                    l.proxy = function(c) {
                        ...
                        if (!c.isImmediatePropagationStopped()) {
                            c.data = H;
                            var b = u.apply(d, c._args == I ? [c] : [c].concat(c._args));
                    ...
                    l.i = z.length;
                    z.push(l);
                    "addEventListener"in d && d.addEventListener(p(l.e), l.proxy, l.del && !c && l.e in K || !!V)
                })
            }
            function R(f, d, z, H, r) {
                var l = g(f);
                (d || "").split(/\s/).forEach(function(d) {
                    h(f, d, z, H).forEach(function(d) {
                        delete E[l][d.i];
                        "removeEventListener"in f && f.removeEventListener(p(d.e), d.proxy, d.del && !c && d.e in K || !!r)
                    })
                })
            }
            function D(c, d) {
                if (d || !c.isDefaultPrevented)
                    ...
                    d.defaultPrevented !== I ? d.defaultPrevented : "returnValue"in d ? !1 === d.returnValue : d.getPreventDefault && d.getPreventDefault())
            ...
            function A(c) {
                ...
                for (d in c)
                    C.test(d) || c[d] === I || (f[d] = c[d]);
                return D(f, c)
            }
            var x = 1, I, M = Array.prototype.slice, X = f.isFunction, J = function(c) {
                return "string" == typeof c
            }, E = {}, G = {}, c = "onfocusin"in d, K = {
                focus: "focusin",
                blur: "focusout"
            }, t = {
            ...
            f.proxy = function(c, d) {
                var l = 2 in arguments && M.call(arguments, 2);
                if (X(c)) {
                    var u = function() {
                        return c.apply(d, l ? l.concat(M.call(arguments)) : arguments)
                    };
                    u._zid = g(c);
                    return u
                }
                if (J(d))
                    return l ? (l.unshift(c[d], c),
                    f.proxy.apply(null, l)) : f.proxy(c[d], c);
                ...
                return z.each(function(z, H) {
                    ...
                    d && (u = function(c) {
                        ...
                        if (g && g !== H) {
                            ...
                            return (l || h).apply(g, [u].concat(M.call(arguments, 1)))
                        }
                    }
                    );
                    O(H, c, h, g, d, u || l)
            ...
            f.fn.trigger = function(c, d) {
                c = J(c) || f.isPlainObject(c) ? f.Event(c) : D(c);
                c._args = d;
                return this.each(function() {
                    if (c.type in K && "function" == typeof this[c.type])
                        this[c.type]();
                    else
            ...
            f.fn.triggerHandler = function(c, d) {
                var g, l;
                this.each(function(u, z) {
                    g = A(J(c) ? f.Event(c) : c);
                    g._args = d;
                    g.target = z;
                    f.each(h(z, c.type || c), function(c, d) {
                        l = d.proxy(g);
            ...
            f.Event = function(c, d) {
                J(c) || (d = c,
                c = d.type);
                var f = document.createEvent(G[c] || "Events")
                  , g = !0;
                if (d)
                    for (var l in d)
                        "bubbles" == l ? g = !!d[l] : f[l] = d[l];
                f.initEvent(c, g, !0);
                return D(f)
            }
        }
        ...
        (function(f) {
            ...
            function O(c, d, f, h, r) {
                var l = h.context;
                h.error.call(l, f, d, c);
                r && r.rejectWith(l, [f, d, c]);
            ...
            function A(c) {
                c && (c = c.split(";", 2)[0]);
                return c && ("text/html" == c ? "html" : "application/json" == c ? "json" : t.test(c) ? "script" : y.test(c) && "xml") || "text"
            }
            function x(c, d) {
            ...
            function I(c) {
                ...
                !c.data || c.type && "GET" != c.type.toUpperCase() && "jsonp" != c.dataType || (c.url = x(c.url, c.data),
                c.data = void 0)
            }
            function M(c, d, g, h) {
                f.isFunction(d) && (h = g,
            ...
            function w(c, d, g, h) {
                var l, r = f.isArray(d), u = f.isPlainObject(d);
                f.each(d, function(d, m) {
                    l = f.type(m);
                    h && (d = g ? h : h + "[" + (u || "object" == l || "array" == l ? d : "") + "]");
                    !h && r ? c.add(m.name, m.value) : "array" == l || !g && "object" == l ? w(c, m, g, d) : c.add(d, m)
                })
            }
            var J = +new Date, E = d.document, G, c, K = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, t = /^(?:text|application)\/javascript/i, y = /^(?:text|application)\/xml/i, L = /^\s*$/, C = E.createElement("a");
            C.href = d.location.href;
            f.active = 0;
            f.ajaxJSONP = function(c, g) {
                if (!("type"in c))
                    return f.ajax(c);
                var h = c.jsonpCallback, l = (f.isFunction(h) ? h() : h) || "Zepto" + J++, r = E.createElement("script"), u = d[l], t, v = function(c) {
                    f(r).triggerHandler("error", c || "abort")
                }, y = {
                    abort: v
                }, V;
                g && g.promise(y);
                f(r).on("load error", function(h, m) {
                    clearTimeout(V);
                    f(r).off().remove();
                    "error" != h.type && t ? p(t[0], y, c, g) : O(null, m || "error", y, c, g);
                    d[l] = u;
                    t && f.isFunction(u) && u(t[0]);
                    u = t = void 0
                });
                if (!1 === m(y, c))
                    return v("abort"),
                ...
                ;
                r.src = c.url.replace(/\?(.+)=\?/, "?$1=" + l);
                E.head.appendChild(r);
                0 < c.timeout && (V = setTimeout(function() {
                    v("timeout")
                }, c.timeout));
                return y
            }
            ...
            f.ajax = function(g) {
                ...
                for (G in f.ajaxSettings)
                    void 0 === l[G] && (l[G] = f.ajaxSettings[G]);
                h(l);
                if (!l.crossDomain) {
                    var u = E.createElement("a");
                    u.href = l.url;
                    u.href = u.href;
                    l.crossDomain = C.protocol + "//" + C.host !== u.protocol + "//" + u.host
                }
                l.url || (l.url = d.location.toString());
                -1 < (u = l.url.indexOf("#")) && (l.url = l.url.slice(0, u));
                I(l);
                var t = l.dataType;
                (u = /\?.+=\?/.test(l.url)) && (t = "jsonp");
                !1 !== l.cache && (g && !0 === g.cache || "script" != t && "jsonp" != t) || (l.url = x(l.url, "_=" + Date.now()));
                if ("jsonp" == t)
                    return u || (l.url = x(l.url, l.jsonp ? l.jsonp + "=?" : !1 === l.jsonp ? "" : "callback=?")),
                    f.ajaxJSONP(l, r);
                g = l.accepts[t];
                var y = {};
                u = function(c, d) {
                ...
                ;
                var V = /^([\w-]+:)\/\//.test(l.url) ? RegExp.$1 : d.location.protocol, v = l.xhr(), R = v.setRequestHeader, ea;
                r && r.promise(v);
                l.crossDomain || u("X-Requested-With", "XMLHttpRequest");
                u("Accept", g || "*/*");
                if (g = l.mimeType || g)
                    -1 < g.indexOf(",") && (g = g.split(",", 2)[0]),
                    v.overrideMimeType && v.overrideMimeType(g);
                (l.contentType || !1 !== l.contentType && l.data && "GET" != l.type.toUpperCase()) && u("Content-Type", l.contentType || "application/x-www-form-urlencoded");
                if (l.headers)
                    for (c in l.headers)
                        u(c, l.headers[c]);
                v.setRequestHeader = u;
                v.onreadystatechange = function() {
                    if (4 == v.readyState) {
                        v.onreadystatechange = D;
                        clearTimeout(ea);
                        var c = !1;
                        if (200 <= v.status && 300 > v.status || 304 == v.status || 0 == v.status && "file:" == V) {
                            t = t || A(l.mimeType || v.getResponseHeader("content-type"));
                            if ("arraybuffer" == v.responseType || "blob" == v.responseType)
                                var d = v.response;
                            else {
                                d = v.responseText;
                                try {
                                    d = l.dataFilter == D ? d : l.dataFilter.call(l.context, d, t),
                                    "script" == t ? (0,
                                    eval)(d) : "xml" == t ? d = v.responseXML : "json" == t && (d = L.test(d) ? null : f.parseJSON(d))
                                } catch (P) {
                                    c = P
                                }
                                if (c)
                                    return O(c, "parsererror", v, l, r)
                            }
                            p(d, v, l, r)
                        } else
                            O(v.statusText || null, v.status ? "error" : "abort", v, l, r)
                    }
                }
                ;
                if (!1 === m(v, l))
                    ...
                    O(null, "abort", v, l, r),
                    v;
                v.open(l.type, l.url, "async"in l ? l.async : !0, l.username, l.password);
                if (l.xhrFields)
                    for (c in l.xhrFields)
                        v[c] = l.xhrFields[c];
                for (c in y)
                    R.apply(v, y[c]);
                0 < l.timeout && (ea = setTimeout(function() {
                    v.onreadystatechange = D;
                    v.abort();
                    O(null, "timeout", v, l, r)
                }, l.timeout));
                v.send(l.data ? l.data : null);
                return v
            }
            ;
            f.get = function() {
                return f.ajax(M.apply(null, arguments))
            }
            ;
            f.post = function() {
            ...
            f.fn.load = function(c, d, g) {
                ...
                c.success = function(c) {
                    h.html(m ? f("<div>").html(c.replace(K, "")).find(m) : c);
                    r && r.apply(h, arguments)
                }
                ;
                f.ajax(c);
                return this
        ...
        (function(d) {
            d.fn.serializeArray = function() {
                ...
                this[0] && d.each(this[0].elements, function(g, r) {
                    h = r.type;
                    (f = r.name) && "fieldset" != r.nodeName.toLowerCase() && !r.disabled && "submit" != h && "reset" != h && "button" != h && "file" != h && ("radio" != h && "checkbox" != h || r.checked) && p(d(r).val())
                });
                return m
            }
            ;
    ...
    (function() {
        function d(a) {
            return function(e, b, d, f) {
                ...
                var k = !l(e) && c.keys(e)
                  , q = (k || e).length
                  , F = 0 < a ? 0 : q - 1;
                3 > arguments.length && (d = e[k ? k[F] : F],
                F += a);
                for (var g = b, h = d; 0 <= F && F < q; F += a) {
                    var r = k ? k[F] : F;
                    h = g(h, e[r], r, e)
                }
                return h
        ...
        function g(a, e, b) {
            return function(k, d, f) {
                var q = 0
                  , g = u(k);
                if ("number" == typeof f)
                    0 < a ? q = 0 <= f ? f : Math.max(f + g, q) : g = 0 <= f ? Math.min(f + 1, g) : f + g + 1;
                else if (b && f && g)
                    return f = b(k, d),
                    k[f] === d ? f : -1;
                if (d !== d)
                    return f = e(A.call(k, q, g), c.isNaN),
                    0 <= f ? f + q : -1;
                for (f = 0 < a ? q : g - 1; 0 <= f && f < g; f += a)
                    if (k[f] === d)
                        return f;
                return -1
            }
        ...
        function h(a, e) {
            var b = T.length
              , d = a.constructor;
            d = c.isFunction(d) && d.prototype || x;
            var f = "constructor";
        ...
        var y = function(a, e) {
          ...
          , l = function(a) {
            a = u(a);
            return "number" == typeof a && 0 <= a && a <= Q
        };
        ...
        c.reject = function(a, e, b) {
            return c.filter(a, c.negate(t(e)), b)
        }
        ;
        ...
        c.sample = function(a, e, b) {
            return null == e || b ? (l(a) || (a = c.values(a)),
        ...
        c.groupBy = z(function(a, e, b) {
            c.has(a, b) ? a[b].push(e) : a[b] = [e]
        });
        c.indexBy = z(function(a, e, b) {
            a[b] = e
        });
        c.countBy = z(function(a, e, b) {
            c.has(a, b) ? a[b]++ : a[b] = 1
        });
        c.toArray = function(a) {
            return a ? c.isArray(a) ? A.call(a) : l(a) ? c.map(a, c.identity) : c.values(a) : []
        }
        ;
        c.size = function(a) {
        ...
        var H = function(a, e, b, d) {
            ...
            for (var g = u(a); d < g; d++) {
                var q = a[d];
                if (l(q) && (c.isArray(q) || c.isArguments(q))) {
                    e || (q = H(q, e, b));
                    var h = 0
                      , r = q.length;
                    for (k.length += r; h < r; )
        ...
        c.uniq = c.unique = function(a, e, b, d) {
            ...
            null != b && (b = t(b, d));
            d = [];
            for (var k = [], f = 0, g = u(a); f < g; f++) {
                var q = a[f]
                  , h = b ? b(q, f, a) : q;
                e ? (f && k === h || d.push(q),
                k = h) : b ? c.contains(k, h) || (k.push(h),
                d.push(q)) : c.contains(d, q) || d.push(q)
            }
            return d
        }
        ;
        ...
        c.intersection = function(a) {
            for (var e = [], b = arguments.length, d = 0, f = u(a); d < f; d++) {
                var g = a[d];
                if (!c.contains(e, g)) {
        ...
        ;
        c.unzip = function(a) {
            for (var e = a && c.max(a, u).length || 0, b = Array(e), d = 0; d < e; d++)
                b[d] = c.pluck(a, d);
            return b
        }
        ;
        c.object = function(a, e) {
            for (var b = {}, c = 0, d = u(a); c < d; c++)
        ...
        c.bind = function(a, e) {
            if (J && a.bind === J)
                return J.apply(a, A.call(arguments, 1));
            if (!c.isFunction(a))
                throw new TypeError("Bind must be called on a function");
            var b = A.call(arguments, 2)
              , d = function() {
                return S(a, d, e, this, b.concat(A.call(arguments)))
            };
            return d
        }
        ;
        c.partial = function(a) {
            var e = A.call(arguments, 1)
              , b = function() {
                for (var d = 0, k = e.length, f = Array(k), g = 0; g < k; g++)
                    f[g] = e[g] === c ? arguments[d++] : e[g];
                for (; d < arguments.length; )
                    f.push(arguments[d++]);
                return S(a, b, this, this, f)
            };
            return b
        }
        ;
        ...
        c.throttle = function(a, b, d) {
            ...
            return function() {
                ...
                e = this;
                f = arguments;
                0 >= F || F > b ? (g && (clearTimeout(g),
                g = null),
                h = q,
                k = a.apply(e, f),
                g || (e = f = null)) : g || !1 === d.trailing || (g = setTimeout(l, F));
                return k
            }
        }
        ;
        c.debounce = function(a, b, d) {
            var e, f, k, g, h, l = function() {
                var q = c.now() - g;
                q < b && 0 <= q ? e = setTimeout(l, b - q) : (e = null,
                d || (h = a.apply(k, f),
                e || (k = f = null)))
            };
            return function() {
        ...
        c.mapObject = function(a, b, d) {
            b = t(b, d);
            d = c.keys(a);
            for (var e = d.length, f = {}, k, g = 0; g < e; g++)
                k = d[g],
                f[k] = b(a[k], k, a);
            return f
        }
        ...
        ;
        c.extend = y(c.allKeys);
        c.extendOwn = c.assign = y(c.keys);
        ...
        var v = function(a, b, d, f) {
            ...
            if (!e) {
                ...
                var g = a.constructor
                  , k = b.constructor;
                if (g !== k && !(c.isFunction(g) && g instanceof g && c.isFunction(k) && k instanceof k) && "constructor"in a && "constructor"in b)
                    return !1
            }
            d = d || [];
            f = f || [];
        ...
        c.template = function(a, b, d) {
            ...
            d = RegExp([(b.escape || U).source, (b.interpolate || U).source, (b.evaluate || U).source].join("|") + "|$", "g");
            var e = 0
              , f = "__p+='";
            a.replace(d, function(b, c, d, g, k) {
                f += a.slice(e, k).replace(Z, P);
                e = k + b.length;
    ...
    (function(d) {
        ...
        if ("function" === typeof define && define.amd)
            h.define(["underscore", "jquery", "exports"], function(g, h, r) {
                f.Backbone = d(f, r, g, h)
            });
        ...
        var p = function(b, a, e) {
            ...
            case 3:
                return function(b, c) {
                    return g[a](this[e], D(b, this), c)
                }
                ;
            case 4:
                return function(b, c, d) {
                    return g[a](this[e], D(b, this), c, d)
                }
                ;
            default:
                return function() {
        ...
        var N = /\s+/
          , I = function(b, a, e, c, d) {
            ...
            if (e && "object" === typeof e)
                ...
                k = g.keys(e); f < k.length; f++)
                    a = I(b, a, k[f], e[k[f]], d);
            else if (e && N.test(e))
                for (k = e.split(N); f < k.length; f++)
                    a = b(a, k[f], c, d);
            else
                a = b(a, e, c, d);
            return a
        ...
        ;
        var M = function(b, a, e, c, d) {
            b._events = I(Q, b._events || {}, a, e, {
                context: c,
                ctx: b,
                listening: d
            });
        ...
        var J = function(b, a, e, c) {
            if (b) {
                ...
                c = c.listeners;
                if (a || e || f) {
                    for (var k = a ? [a] : g.keys(b); d < k.length; d++) {
                        a = k[d];
                        var h = b[a];
                        if (!h)
                            break;
                        for (var l = [], r = 0; r < h.length; r++) {
                            var m = h[r];
                            e && e !== m.callback && e !== m.callback._callback || f && f !== m.context ? l.push(m) : (m = m.listening) && 0 === --m.count && (delete c[m.id],
                            delete m.listeningTo[m.objId])
                        }
        ...
        h.trigger = function(b) {
            ...
            for (var a = Math.max(0, arguments.length - 1), e = Array(a), c = 0; c < a; c++)
                e[c] = arguments[c + 1];
            I(G, this._events, b, void 0, e);
            return this
        }
        ;
        var G = function(b, a, e, d) {
            if (b) {
                e = b[a];
                var f = b.all;
                e && f && (f = f.slice());
        ...
        g.extend(K.prototype, h, {
            ...
            set: function(b, a, e) {
                ...
                this.changed = {});
                var l = this.attributes, m = this.changed, r = this._previousAttributes, p;
                for (p in c)
                    a = c[p],
                    g.isEqual(l[p], a) || f.push(p),
                    g.isEqual(r[p], a) ? delete m[p] : m[p] = a,
                    d ? delete l[p] : l[p] = a;
                this.idAttribute in c && (this.id = this.get(this.idAttribute));
                if (!b)
                    for (f.length && (this._pending = e),
                    a = 0; a < f.length; a++)
                        this.trigger("change:" + f[a], this, l[f[a]], e);
                if (h)
                    return this;
                if (!b)
                    for (; this._pending; )
            ...
            destroy: function(b) {
                ...
                ;
                var h = !1;
                this.isNew() ? g.defer(b.success) : (P(this, b),
        ...
        var t = f.Collection = function(b, a) {
            a || (a = {});
        ...
        g.extend(t.prototype, h, {
            ...
            set: function(b, a) {
                if (null != b) {
                    ...
                    0 > d && (d += this.length + 1);
                    var f = [], h = [], l = [], m = [], r = {}, p = a.add, t = a.merge, u = a.remove, n = !1, v = this.comparator && null == d && !1 !== a.sort, z = g.isString(this.comparator) ? this.comparator : null, x;
                    for (x = 0; x < b.length; x++) {
                        var w = b[x];
                        var A = this.get(w);
                        A ? (t && w !== A && (w = this._isModel(w) ? w.attributes : w,
                        a.parse && (w = A.parse(w, a)),
                        A.set(w, a),
                        l.push(A),
                        v && !n && (n = A.hasChanged(z))),
                        r[A.cid] || (r[A.cid] = !0,
                        f.push(A)),
                        b[x] = A) : p && (w = b[x] = this._prepareModel(w, a)) && (h.push(w),
                        this._addReference(w, a),
                        r[w.cid] = !0,
                        f.push(w))
                    }
                    if (u) {
                        for (x = 0; x < this.length; x++)
                            w = this.models[x],
                            r[w.cid] || m.push(w);
                        m.length && this._removeModels(m, a)
                    }
                    r = !1;
                    f.length && !v && p && u ? (r = this.length !== f.length || g.some(this.models, function(a, b) {
                        return a !== f[b]
                    }),
                    this.models.length = 0,
                    C(this.models, f, 0),
                    this.length = this.models.length) : h.length && (v && (n = !0),
                    C(this.models, h, null == d ? this.length : d),
                    ...
                    if (!a.silent) {
                        for (x = 0; x < h.length; x++)
                            null != d && (a.index = d + x),
                            w = h[x],
                            w.trigger("add", w, this, a);
                        (n || r) && this.trigger("sort", this, a);
                        if (h.length || m.length || l.length)
                            a.changes = {
                                added: h,
                                removed: m,
                                merged: l
        ...
        g.extend(z.prototype, h, {
            ...
            _routeToRegExp: function(b) {
                b = b.replace(T, "\\$&").replace(H, "(?:$1)?").replace(S, function(a, b) {
                    return b ? a : "([^/?]+)"
                }).replace(W, "([^?]*?)");
        ...
        var v = f.History = function() {
            this.handlers = [];
            this.checkUrl = g.bind(this.checkUrl, this);
            "undefined" !== typeof x && (this.location = x.location,
        ...
        g.extend(v.prototype, h, {
            ...
            start: function(b) {
                ...
                this._hasHashChange = "onhashchange"in x && (void 0 === document.documentMode || 7 < document.documentMode);
                ...
                b = x.addEventListener || function(a, b) {
            ...
            stop: function() {
                var b = x.removeEventListener || function(a, b) {
        ...
        f.history = new v;
        K.extend = t.extend = z.extend = w.extend = v.extend = function(b, a) {
            var c = this;
    ...
    var m = x._.noConflict()
      , Q = x.Backbone.noConflict()
      , p = N
      , h = {};
    h.core = h.core || {};
    h.core.LOGGING_ENABLED = !0;
    h.core.log = function() {
        if (h.core.LOGGING_ENABLED && "undefined" !== typeof console && !m.isNull(console) && "function" === typeof console.log) {
    ...
    h.core.parseQueryString = function(d) {
        for (var f = {}, g = /\+/g, h = /([^&=]+)=?([^&]*)/g, m; m = h.exec(d); )
            f[decodeURIComponent(m[1].replace(g, " "))] = decodeURIComponent(m[2].replace(g, " "));
        return f
    }
    ;
    ...
    h.platforms.shopify.isVariantOutOfInventory = function(d, f) {
        const inventoryQuantity = window.variantQuantityMap[d.id];
        return m.isNull(inventoryQuantity) || m.isUndefined(inventoryQuantity) ? !d.available : inventoryQuantity < f.inventory_quantity_threshold
    }
    ;
    ...
    h.platforms.shopify.isVariantIncludedBasedOnTags = function(d, f, g) {
        return g.length && d.tags.length && m.intersection(d.tags, g).length || f.length && (!m.intersection(d.tags, f).length || !d.tags.length) ? !1 : !0
    }
    ;
    h.platforms.shopify.findSelectedVariantId = function() {
        var d = x.location.search.substring(1);
        return (d = h.core.parseQueryString(d).variant) ? d : p('[name="id"]').val()
    }
    ;
    h.platforms.shopify.isValidVariant = function(d) {
        return "number" != typeof d ? !1 : !0
    }
    ;
    h.platforms.shopify.productDetailsUrl = function(d) {
        return m.isUndefined(d.product_handle) ? "//" + (x.location.hostname.toString() + x.location.pathname.toString().replace(/\/$/, "")) + ".js" : "//" + x.location.hostname.toString() + "/products/" + d.product_handle + ".js"
    }
    ;
    ...
    h.platforms.bigcommerce.ADD_TO_CART_FORM_ID = 'form[action$="//' + x.location.hostname + '/cart.php"]';
    ...
    h.platforms.bigcommerce.isVariantOutOfInventory = function(d, f) {
        return m.isNull(d.inventory_quantity) || m.isUndefined(d.inventory_quantity) ? !d.available : d.inventory_quantity < f.inventory_quantity_threshold
    }
    ;
    ...
    h.platforms.bigcommerce.findSelectedVariantId = function() {
        var d = []
          , f = p(h.platforms.bigcommerce.ADD_TO_CART_FORM_ID + " " + h.platforms.bigcommerce.OPTION_NAME_ELEMENT + ":checked");
        h.platforms.bigcommerce.selected_variant_id = null;
        if (!m.isEmpty(f))
            return m.each(f, function(f, h) {
                d.push(f.name + "=" + p(f).val())
            }),
            product_id = h.platforms.bigcommerce.productId(),
            variant_option_url = "//" + x.location.hostname + "/remote/v1/product-attributes/" + product_id,
    ...
    h.platforms.bigcommerce.format_product_json = function(d) {
        ...
        m.each(data.variants, function(d, g) {
            variant_title = m.isEmpty(d.title) ? d.sku : d.title;
    ...
    h.components.back_in_stock.Settings = Q.Model.extend({
        defaults: {
            exclude_on_tags: "",
            include_on_tags: "",
    ...
    h.components.back_in_stock.Main = Q.Model.extend();
    h.components.back_in_stock.MainView = Q.View.extend({
        events: {
        ...
        initialize: function(d) {
            ...
            else if (this.platform_implementation.isCollectionsPage())
        ...
        getProductJSON: function(d, f) {
            ...
            p.getJSON(d, function(d, p, w) {
                ...
                m.each(p, function(d, f) {
                    g.isVariantOutOfStock(d) && r.push(d);
                    x[d.id] = d;
                    D[d.title] = d
                });
                g.model.set({
                    variants: p,
                    unavailable_variants: r,
                    variants_by_id: x,
                    variants_by_title: D
                });
                h.core.log("Variants: ", p.length, "Unavailable Variants: ", r.length);
                f()
            })
        },
                ...
                if (d.model.get("unavailable_variants").length) {
                    ...
                    if (!f.length) {
                        ...
                        var g = p(d.platform_implementation.ADD_TO_CART_BUTTON_ID).eq(0)
                          ...
                          , w = "#" + h;
                        !m.isNull(h) && p(w).length ? (g = p(w).eq(0),
        ...
        prepareTriggerElement: function(d) {
            var f = this.settings()
              , g = {};
            m.defaults(g, f.get("trigger"), h.components.back_in_stock.DEFAULT_SETTINGS.trigger);
        ...
        createModal: function() {
            ...
            m.isUndefined(parent_body_font_family) || (h.components.back_in_stock.DEFAULT_SETTINGS.modal.font_family = parent_body_font_family);
            m.isUndefined(parent_body_font_color) || (h.components.back_in_stock.DEFAULT_SETTINGS.modal.text_color = parent_body_font_color);
            m.isUndefined(parent_headers_font_family) || (h.components.back_in_stock.DEFAULT_SETTINGS.modal.headers_font_family = parent_headers_font_family);
            m.isUndefined(parent_button_text_color) || (h.components.back_in_stock.DEFAULT_SETTINGS.modal.button_text_color = parent_button_text_color);
            m.isUndefined(parent_button_background_color) || (h.components.back_in_stock.DEFAULT_SETTINGS.modal.button_background_color = parent_button_background_color);
            m.defaults(f, d.get("modal"), h.components.back_in_stock.DEFAULT_SETTINGS.modal);
            m.extend(f, {
        ...
        variantChange: function(d) {
            if (!this.model.get("is_on_other_page") && !this.model.get("is_on_collections_page") && this.trigger instanceof Q.View) {
        ...
        setVariantAndShowUI: function(d) {
            if (m.isUndefined(d) || m.isNull(d))
                this.trigger.hide(),
                m.isUndefined(this.sold_out_button) || this.sold_out_button.show();
            else {
                ...
                f || this.trigger.hide();
                this.isVariantOutOfStock(f) ? (m.isUndefined(this.sold_out_button) || !this.trigger.model.get("replace_anchor") && !this.trigger.model.get("replace_sold_out") || this.sold_out_button.hide(),
        ...
        handleBISTriggerClick: function(d) {
            ...
            if (this.model.get("is_on_collections_page")) {
                ...
                f.getProductJSON(d, function() {
                    !m.isUndefined(h) && m.isUndefined(this.modal) && f.createModal();
                    f.showModal(h)
                })
            } else
                f.showModal()
    ...
    h.components = h.components || {};
    h.components.back_in_stock = h.components.back_in_stock || {};
    h.components.back_in_stock.Trigger = Q.Model.extend({});
    h.components.back_in_stock.TriggerView = Q.View.extend({
        initialize: function(d) {},
        ...
        renderProductPageTrigger: function() {
            var d = this.model;
            this.$el.attr("class", d.get("product_page_class")).addClass("klaviyo-bis-trigger").attr("href", "#").text(d.get("product_page_text")).css("text-align", d.get("product_page_text_align")).css("margin", d.get("product_page_margin"))
        },
        show: function() {
            this.$el.show()
        },
    ...
    h.components.back_in_stock.Modal = Q.Model.extend();
    h.components.back_in_stock.ModalView = Q.View.extend({
        initialize: function(d) {},
        ...
        renderForm: function(d, f, g, r) {
            var w = this;
            r = h.core.templates.render("back_in_stock_document.html", {
                variant: f,
                product: d,
                unavailable_variants: r,
            ...
            ;
            p(d).find("body").on("click", m.bind(r, this)).on("touchend", m.bind(r, this)).find("form").on("submit", m.bind(this.validateAndSubmitForm, this));
        ...
        validateAndSubmitForm: function(d) {
            ...
            var h = p(d).find("#email").val()
              , m = p(d).find("#subscribe_for_newsletter").prop("checked") && "none" !== p(d).find("#newsletter_subscription")[0].style.display;
            ...
            p.post(g, {
                ...
                subscribe_for_newsletter: m
            }, function(d, g, h) {
                p(f.iframeDocument()).find("form").find("button").removeAttr("disabled");
                d.success ? f.showSuccessMessage() : f.showErrorMessage(d.errors.join(" "))
            }))
        },
        showSuccessMessage: function() {
            p(this.iframeDocument()).find("#completed_message").show();
            m.delay(m.bind(this.hide, this), 3E5)
        },
    ...
    var w = x.klaviyo;
    w && w._initialized || (m.isArray(w) || (x.klaviyo = [],
    w = x.klaviyo),
    m.each(["init", "logging", "enable"], function(d) {
        w[d] = function() {
            var f = [].slice.call(arguments);
            return w.push([d].concat(f))
        }
    }),
    N(function(d) {
        ...
        for (d = function(d) {
            ...
            if (m.isArray(d) && d && h.components.Router[d[0]])
